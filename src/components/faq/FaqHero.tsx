...
export default function FaqHero() {
  return (
    <section className="pt-26 pb-16 px-4 md:px-8 max-w-7xl mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        {/* Left Content */}
        <div className="flex flex-col items-start relative z-10">
          <div className="text-[#d6eef4] bg-[#23a4e1]/95 text-[10px] font-serif font-bold tracking-widest pb-1.5 pt-2 px-4 rounded-full mb-6 uppercase shadow-sm">
            Support Center
          </div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold font-serif text-[#0f172a] mb-6 tracking-tight leading-[1.1]">
        ...
        <div className="relative mt-4 lg:mt-0">
          ...
          {/* Floating Card */}
          <div className="absolute -bottom-8 -left-2 md:-left-6 bg-linear-to-br from-white/80 to-slate-50/70 px-4 py-3 rounded-xl shadow-xl border border-white/60 max-w-[280px] z-20 backdrop-blur-sm">
