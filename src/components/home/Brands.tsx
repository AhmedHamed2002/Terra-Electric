        ...
        <div className="relative w-full overflow-hidden py-4">
          ...
          <div className="flex w-max animate-scroll items-center gap-12 md:gap-24 opacity-60">
            {[...brands, ...brands].map((brand, index) => (
              <div
                key={index}
                className="text-2xl md:text-3xl font-bold text-gray-500 uppercase tracking-widest grayscale hover:grayscale-0 hover:text-[#176a88] transition-all duration-300 whitespace-nowrap"
              >
                {brand}
              </div>
            ))}
